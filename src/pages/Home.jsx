...
const Home = () => {
    ...
    return (
        <>
         <section className="relative bg-[url('/assets/img/hero/hero-bg-1.png')] bg-no-repeat bg-cover bg-[right_-146px_bottom] md:bg-[right_-90px_bottom] lg:bg-center before:absolute before:inset-0 before:bg-[#5F9EA0] before:opacity-50 md:before:opacity-70 lg:before:hidden">
